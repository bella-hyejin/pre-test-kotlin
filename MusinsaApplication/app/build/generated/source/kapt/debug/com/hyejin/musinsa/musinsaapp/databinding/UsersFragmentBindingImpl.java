...
public class UsersFragmentBindingImpl extends UsersFragmentBinding  {
    ...
    public UsersFragmentBindingImpl(@Nullable androidx.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 2, sIncludes, sViewsWithIds));
    }
    private UsersFragmentBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
    ...
    protected void executeBindings() {
        ...
        if ((dirtyFlags & 0x3L) != 0) {
            ...
            com.hyejin.musinsa.musinsaapp.ui.search.users.UsersBindings.loadUsers(this.usersList, users);
        }
    }
